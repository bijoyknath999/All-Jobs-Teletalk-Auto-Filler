(function() {
  ...
  fillFormBtn.addEventListener('click', function() {
    ...
    try {
      ...
      // Reset job fill flag so it runs once per fill
      fillEducationFieldsDirectly._jobsDone = false;
  ...
  function fillEducationFieldsDirectly(data) {
    ...
    if (!fillEducationFieldsDirectly._jobsDone) {
      fillEducationFieldsDirectly._jobsDone = true;
